...
import com.whatevercode.gpsseguros.Poliza.PolizaService;

@Service
public class PolizaVehiculoService implements PolizaService<PolizaVehiculo>{
	...
	@Override
	public Optional<PolizaVehiculo> delete(String id) {
		try {
